...
{{< include Include/diffusion-unconstrained-contagion.qmd >}}


### Bounded virality: Finite Populations


{{< include Include/diffusion-finite-population.qmd}}
...
<!-- {{< include Include/diffusion-guided-virality.qmd >}} -->



{{< include Include/diffusion-contagion-ce-equivalence.qmd}}



## Discussion

The social diffusion of sustainable practices, or any behavior, occurs through social learning between individuals over time. If there are many who have not yet adopted some practice and that practice is more likely to to be adopted than dropped, the spread of that practice will seem like it will forever accelerate. When a significant proportion of individuals in a population begin to 



This conceptualization generates some new questions whose answers could further serve the cause of promoting sustainability through intelligent intervention design. 
